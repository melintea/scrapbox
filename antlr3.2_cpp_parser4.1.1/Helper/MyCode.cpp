...
*/
/*
 * Adapted for ANTLR 3.2 on Oct 31, 2012.
 */
...
void MyCode::myCode_pre_processing(int argc,char *argv[])
	...
	printf("Version 4.1 - October 2012\n\n");
	printf("MyCode, a program to demonstrate how to use the parser.\n");
	...
	fprintf(myDatFilePtr,"Version 4.1 - October 2012\n\n");
