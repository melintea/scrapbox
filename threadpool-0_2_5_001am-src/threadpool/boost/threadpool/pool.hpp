 ...
 */
    ...
    typedef typename pool_core_type::queue_id_type  queue_id_type;
  ...
  public:
    ...
    */
     ...
     */  
     ...
     /*!
     * Schedule a task to queue \param queue_id. 
     */
     bool schedule(queue_id_type queue_id, task_type const & task)
     {	
       return m_core->schedule(queue_id, task);
     }
